...
# read data
PD <- readRDS("tables/2_accidents_estimation/reg_out/baseline_data.rds")
# Data for Each Model 
ES <- readRDS("tables/2_accidents_estimation/reg_out/Event_Study_data.rds")
C3 <- readRDS("tables/2_accidents_estimation/reg_out/Control_3_data.rds")
# regression results
m0 <- readRDS("tables/2_accidents_estimation/reg_out/Event_Study_model_CATT.rds")
m3 <- readRDS("tables/2_accidents_estimation/reg_out/Control_3_model_3.rds")
